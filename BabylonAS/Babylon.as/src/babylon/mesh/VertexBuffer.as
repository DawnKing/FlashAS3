package babylon.mesh {
    ...
    public class VertexBuffer {
        ...
        public function VertexBuffer(engine: Engine, data: Object, kind: String, updatable: Boolean, postponeInternalCreation: Boolean = false, stride: int = 0, instanced: Boolean = false, offset: int = 0, size: String = null) {
            var format: String;
            if (!stride) {
