package babylon.culling {
    ...
    public class BoundingBox {
        public var vectors: Vector.<Vector3> = new <Vector3>[];
        public var center: Vector3;
        public var extendSize: Vector3;
        public var directions: Vector.<Vector3>;
        public var vectorsWorld: Vector.<Vector3> = new <Vector3>[];
        ...
        public function BoundingBox(minimum: Vector3, maximum: Vector3) {
            ...
            this.directions = new <Vector3>[Vector3.Zero(), Vector3.Zero(), Vector3.Zero()];

            // World
            for (var index: int = 0; index < this.vectors.length; index++) {
        ...
        public function intersectsPoint(point: Vector3): Boolean {
            var delta: Number = -MathTools.Epsilon;
        ...
        public function intersectsSphere(sphere: BoundingSphere): Boolean {
            return BoundingBox.IntersectsSphere(this.minimumWorld, this.maximumWorld, sphere.centerWorld, sphere.radiusWorld);
        }

        public function intersectsMinMax(min: Vector3, max: Vector3): Boolean {
        ...
        // Statics
        public static function Intersects(box0: BoundingBox, box1: BoundingBox): Boolean {
        ...
        public static function IntersectsSphere(minPoint: Vector3, maxPoint: Vector3, sphereCenter: Vector3, sphereRadius: Number): Boolean {
            var vector: Vector3 = Vector3.Clamp(sphereCenter, minPoint, maxPoint);
            var num: Number = Vector3.DistanceSquared(sphereCenter, vector);
            return (num <= (sphereRadius * sphereRadius));
        }

        public static function IsCompletelyInFrustum(boundingVectors: Vector.<Vector3>, frustumPlanes: Vector.<Plane>): Boolean {
        ...
        public static function IsInFrustum(boundingVectors: Vector.<Vector3>, frustumPlanes: Vector.<Plane>): Boolean {
            for (var p: int = 0; p < 6; p++) {
                var inCount: int = 8;
