...
package easiest.rendering.materials.textures
{
    ...
    {
        private var _parent:BaseTexture;
        ...
        public function SubTexture(parent:BaseTexture, region:Rectangle=null,
        ...
        private function setTo(parent:BaseTexture, region:Rectangle=null,
                               ownsParent:Boolean=false, frame:Rectangle=null,
        ...
        {
            if (_ownsParent) _parent.clear(null);
        }
