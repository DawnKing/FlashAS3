package easiest.managers
{
    ...
    public final class FrameManager
    {
        ...
        private static var _deltaTime:Number = 0; // 表示从上一帧到当前帧时间，以毫秒为单位。
        ...
        private static var _time:Number = 0.0;  // 启动FrameManager以来经过的毫秒数
        ...
        private static function onEnterFrame(event:Event):void
        {
            ...
            _time += passedTime * frameRate;
            Assert.assertEquals1(_time, now);
        ...
        private static function processFrameCount():void
        {
            ...
            _frameScore = _spf / ((_time - _lastScoreTime) / SAMPLE_COUNT) * 100;
            if (_lastScoreTime == 0)
                _frameScore = 100;
