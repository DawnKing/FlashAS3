    ...
    public class Buffer {
        ...
        public function create(data: Vector.<Number> = null): void {
            ...
            if (!this._buffer) { // create buffer
                if (this._updatable) {
                    this._buffer = this._engine.createVertexBuffer(data, this._strideSize, Context3DBufferUsage.DYNAMIC_DRAW);
                    this._data = data;
                } else {
                    this._buffer = this._engine.createVertexBuffer(data, this._strideSize, Context3DBufferUsage.STATIC_DRAW);
                }
