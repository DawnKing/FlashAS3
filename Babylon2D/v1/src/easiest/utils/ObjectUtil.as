...
public class ObjectUtil
{
            ...
            switch(typeOfA)
            {
                ...
                case "object":
                {
                    ...
                    else if (getQualifiedClassName(a) == getQualifiedClassName(b))
                    {
                        ...
                        var isDynamicObject:Boolean = Function(isDynamicObject)(a);
    ...
    */
    ...
    /**
     *  Returns <code>true</code> if the object is an instance of a isDynamic class.
     *
                                         ...
                                         refs:Dictionary):int
    {
        ...
        else
        {
            ...
            for (key in a)
            {
                if (b.hasOwnProperty(key as String))
                {
            ...
            for (key in b)
            {
                if (!a.hasOwnProperty(key as String))
                {
                    return 1;
                }
            }
    ...
    public static function getFunctionDebugInfo(func:Function):String
    {
        var obj:Object = getSavedThis(func);
        var url:String = "";
        if (url != null)
            url = url.slice(url.lastIndexOf("/")+1);
        return NameUtil.getUnqualifiedClassName(obj)+" "+url;
    }
}
